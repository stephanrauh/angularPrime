...
$(function() {
    ...
    $.widget("primeui.puipicklist", {
            ...
            if(this.options.dragdrop) {                
                this.element.find('> .pui-picklist-listwrapper > ul.pui-picklist-list').sortable({
                    ...
                    update: function(event, ui) {
                        ...
                        $this._saveState(false);  // changed for AngularPrime
                    },
                ...
                items.hide(this.options.effect, {}, this.options.effectSpeed, function() {
                    ...
                    item.appendTo(to).show($this.options.effect, {}, $this.options.effectSpeed, function() {
                        ...
                        if(transferCount === itemsCount) {
                            $this._saveState(true);  // Changed for AngularPrime
        ...
        _saveState: function(silent) {  // Changed for AngularPrime
            ...
            if (!silent) {
                var obj = {};
                obj.items = this.targetList.find('li');
                this._trigger('reorder', null, obj);
            }
        },
        ...
        deselectAll: function() {
            var items = this.targetList.children('li.pui-picklist-item');
            items.hide().removeClass('ui-state-highlight ui-state-hover').appendTo(this.sourceList).show();
